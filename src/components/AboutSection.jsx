        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground">
              I specialize in front-end development, focusing on building
              user-friendly interfaces and seamless user experiences. I am
              proficient in modern web technologies such as React, Next.js, and
              Tailwind CSS.
            </p>
            ...
            <div className="gradient-border p-6 card-hover">
              <div className="flex items-start gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-muted-foreground">
                    Crafting user-centered designs that are both functional and
